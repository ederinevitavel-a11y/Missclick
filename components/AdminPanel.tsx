...
const AdminPanel: React.FC<AdminPanelProps> = ({ claims, respawns, blockedUsers, fixedRespawns, warnings, onClose, onForceDelete, onRefreshData }) => {
  ...
  return (
    <div className="bg-[#0b1121] min-h-screen p-3 sm:p-4 md:p-8 animate-in fade-in duration-300">
      
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        
        {/* Header Admin - Green Theme */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-emerald-950/20 border border-emerald-900/50 p-4 sm:p-6 rounded-lg relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 sm:gap-4 z-10 w-full md:w-auto">
                <div className="p-2 sm:p-3 bg-emerald-950/50 rounded-lg border border-emerald-800 text-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                    <ShieldAlert size={24} className="sm:w-8 sm:h-8" />
                </div>
                <div>
                    <h2 className="text-lg sm:text-2xl font-bold text-emerald-100 tracking-widest digital-font">PAINEL ADMINISTRATIVO</h2>
                    <p className="text-emerald-400 text-[10px] font-mono uppercase tracking-widest mt-0.5 sm:mt-1">Acesso Restrito</p>
                </div>
            </div>

            <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                 <div className="flex bg-slate-900/80 p-1 rounded-lg border border-slate-700 w-full md:w-auto overflow-x-auto no-scrollbar">
                    <button 
                ...
                <button 
                    onClick={onClose}
                    className="w-full sm:w-auto px-6 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-lg text-xs font-bold uppercase tracking-widest transition-all border border-slate-700 flex items-center justify-center gap-2"
                >
                    <X size={16} /> Voltar
                </button>
            </div>
